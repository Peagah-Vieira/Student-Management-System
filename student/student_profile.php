            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800"><?=$db_student['Username']?> Profile</h1>
                                            ...
                                            <div class="col-lg-12">
                                                <div class="card-body">
                                                    <div class="form-outline mb-2">
                                                        ...
                                                        <input type="text" id="form2Example11" class="form-control" value="<?=$db_student['StudentName']?>" disabled/>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-12">
                                                <div class="card-body">
                                                    <div class="form-outline mb-2">
                                                        ...
                                                        <input type="text" id="form2Example11" class="form-control" value="<?=$db_student['Username']?>" disabled/>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-12">
                                                <div class="card-body">
                                                    <div class="form-outline mb-2">
                                                        ...
                                                        <input type="email" id="form2Example11" class="form-control" value="<?=$db_student['ContactNumber']?>" disabled/>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-12">
                                                <div class="card-body">
                                                    <div class="form-outline mb-2">
                                                        ...
                                                        <input type="email" id="form2Example11" class="form-control" value="<?=$db_student['StudentEmail']?>" disabled/>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-12">
                                                <div class="card-body">
                                                    <div class="form-outline mb-2">
                                                        <label class="form-label font-weight-medium text-dark" for="form2Example11">Admission Date</label>
                                                        <input type="text" id="form2Example11" class="form-control" value="<?=$db_student['AdmissionDate']?>" disabled/>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
