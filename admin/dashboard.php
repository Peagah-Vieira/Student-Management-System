            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header text-dark">Class Management:</h6>
                        <a class="collapse-item font-weight-light text-dark" href="add_class.html">Register Class</a>
                        <a class="collapse-item font-weight-light text-dark" href="manage_class.html">Manage Class</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item font-weight-light text-dark" href="add_student.html">Register Student</a>
                        <a class="collapse-item font-weight-light text-dark" href="manage_student.html">Manage Student</a>
                        <a class="collapse-item font-weight-light text-dark" href="search.html">Search Student</a>
                    </div>
                </div>
            </li>
            ...
            <div id="content">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small"><?=$db_admin['Username']?></span>
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Report Summary</h1>
