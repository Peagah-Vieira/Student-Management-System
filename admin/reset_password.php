            ...
            <div class="card-body px-5 pt-5 text-center">
              <form action="" method="POST">
                ...
                <div class="mb-md-5 mt-md-4 pb-5">
                  ...
                  <h2 class="fw-bold mb-2 text-uppercas">Enter your NEW PASSWORD</h2>
                  <p class="text-white-50 mb-5">Enter a password to change your password!</p>

                  <div class="form-outline form-white mb-4">
                    <input type="password" id="typeUsernameX" class="form-control form-control-lg" placeholder="Password" name="password" required/>
                  </div>

                  <div class="form-outline form-white mb-4">
                    <input type="password" id="typeUsernameX" class="form-control form-control-lg" placeholder="Confirm Password" name="confirmPassword" required/>
                  </div>
