    ...
    <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item font-weight-light text-dark" href="add_class.php">Register Class</a>
                <a class="collapse-item font-weight-light text-dark" href="manage_class.php">Manage Class</a>
            </div>
        </div>
    </li>
    ...
    <li class="nav-item">
        ...
        <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item font-weight-light text-dark" href="../index.php">Index</a>
                <a class="collapse-item font-weight-light text-dark" href="../forgot.php">Forgot Password</a>
            </div>
        </div>
    </li>
